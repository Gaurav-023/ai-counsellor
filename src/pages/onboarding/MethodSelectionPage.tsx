...
import { Box, Typography, Card, CardContent, Stack, Grid, Container, Paper } from '@mui/material';
import { useNavigate, Link } from 'react-router-dom';
import { File01Icon, BubbleChatIcon, ArrowRight01Icon, SparklesIcon, ArrowLeft01Icon } from 'hugeicons-react';
    ...
    return (
        <Box
            sx={{
                ...
                // Same scenic background as OnboardingLayout (Dark Vibe)
                background: `
                ...
                >
                    <Paper
                        ...
                        sx={{
                            p: { xs: 3, sm: 5 },
                            borderRadius: 4,
                            // Glassmorphism effect consistent with OnboardingLayout
                            bgcolor: 'rgba(25, 25, 35, 0.4)',
